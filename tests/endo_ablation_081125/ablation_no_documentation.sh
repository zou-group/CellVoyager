...
#SBATCH --output=endo_ablation_081125/ablation_no_documentation_%j.out
#SBATCH --error=endo_ablation_081125/ablation_no_documentation_%j.err
#SBATCH --time=6:00:00
#SBATCH --mem=128G
...
python single_ablation_test.py \
    ...
    --num-analyses 25 \
    --max-iterations 8 \
    --output-dir "endo_ablation_081125" \
    --use-self-critique \
    --use-vlm \
    --no-documentation
