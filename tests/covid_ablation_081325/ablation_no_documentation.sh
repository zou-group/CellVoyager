...
#SBATCH --output=covid_ablation_081325/ablation_no_documentation_%j.out
#SBATCH --error=covid_ablation_081325/ablation_no_documentation_%j.err
...
python single_ablation_test.py \
    ...
    --num-analyses 25 \
    --max-iterations 8 \
    --output-dir "covid_ablation_081325" \
    --use-self-critique \
    --use-vlm \
    --no-documentation
