...
#SBATCH --output=covid_ablation_080725/ablation_no_vlm_no_critique_%j.out
#SBATCH --error=covid_ablation_080725/ablation_no_vlm_no_critique_%j.err
#SBATCH --time=6:00:00
#SBATCH --mem=128G
...
python single_ablation_test.py \
    ...
    --num-analyses 25 \
    --max-iterations 8 \
    --output-dir "covid_ablation_080725" \
    --no-self-critique \
    --no-vlm
